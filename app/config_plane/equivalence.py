...
def evaluate_equivalence(baseline: EffectiveConfigManifest, target: EffectiveConfigManifest) -> ConfigEquivalenceReport:
    ...
    divergences = [f"{d.parameter_ref.domain.value}.{d.parameter_ref.name}" for d in diffs]
