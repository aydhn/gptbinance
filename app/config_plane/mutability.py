...
DEFAULT_POLICIES = {
    ...
    MutabilityClass.RELEASE_ONLY: MutabilityPolicy(
        ...
        allowed_layer_classes=[LayerClass.BASE_DEFAULTS, LayerClass.WORKSPACE_DEFAULTS, LayerClass.PROFILE_DEFAULTS, LayerClass.CANDIDATE_BUNDLE],
        requires_review=True
    ),
    MutabilityClass.REVIEW_ONLY: MutabilityPolicy(
        mutability_class=MutabilityClass.REVIEW_ONLY,
        allowed_layer_classes=[LayerClass.CANDIDATE_BUNDLE, LayerClass.DEGRADED_MODE_OVERLAY],
        requires_review=True
    ),
    MutabilityClass.RUNTIME_SAFE: MutabilityPolicy(
        mutability_class=MutabilityClass.RUNTIME_SAFE,
        allowed_layer_classes=[LayerClass.CANDIDATE_BUNDLE, LayerClass.DEGRADED_MODE_OVERLAY, LayerClass.RUNTIME_SAFE_PATCH_INTENT, LayerClass.EXPERIMENT_CANDIDATE_OVERLAY],
    ...
    MutabilityClass.EMERGENCY_OVERLAY_ONLY: MutabilityPolicy(
        ...
        allowed_layer_classes=[LayerClass.INCIDENT_CONTAINMENT_OVERLAY, LayerClass.REMEDIATION_RECOVERY_OVERLAY],
        requires_review=True
    )
}

def validate_mutability(mutability_class: MutabilityClass, target_layer_class: LayerClass):
