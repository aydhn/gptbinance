...
class SchemaRegistry:
    ...
    def get_schema(self, ref: SchemaVersionRef) -> DataSchema:
        if ref.schema_id not in self._schemas or ref.version not in self._schemas[ref.schema_id]:
            raise InvalidSchemaVersionError(f"Schema {ref.schema_id} version {ref.version} not found")
