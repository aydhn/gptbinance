...
class TrustVerdictEngine:
    @staticmethod
    def evaluate(manifest_id: str, preflight_blockers: list, equivalence_verdict: str, quality_score: int) -> TrustedExecutionVerdict:
        ...
        if quality_score < 50:
             if verdict not in [TrustedExecutionVerdictClass.BLOCKED, TrustedExecutionVerdictClass.DEGRADED]:
