...
class SeverityMatrix:
    ...
    def evaluate_initial(signal: IncidentSignal) -> IncidentSeverity:
        critical_types = [SignalType.MARKET_TRUTH_BROKEN, SignalType.CROSS_BOOK_CONFLICT]
        major_types = [SignalType.SHADOW_DRIFT_CRITICAL, SignalType.CAPITAL_FREEZE_ESCALATED, SignalType.POLICY_HARD_BLOCK]
    ...
    @staticmethod
    def escalate(current: IncidentSeverity, new_signal: IncidentSignal) -> IncidentSeverity:
