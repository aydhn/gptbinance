class RunbookRef:
    RELEASE_INTEGRITY_REVIEW = "release_integrity_review_runbook"
    ROLLOUT_INVESTIGATION = "rollout_investigation_runbook"
    HIDDEN_HOTFIX_REVIEW = "hidden_hotfix_review_runbook"
