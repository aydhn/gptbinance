...
class ProductRegistry:
    ...
    def _initialize_defaults(self):
        self.register_product(ProductDescriptor(
            ...
            cost_model=ProductCostModel(has_funding_fee=False, has_borrow_interest=False)
        ))
        ...
        self.register_product(ProductDescriptor(
            ...
            constraints=ProductExecutionConstraints(min_notional=10.0),
            cost_model=ProductCostModel(has_funding_fee=False, has_borrow_interest=True)
        ))
        ...
        self.register_product(ProductDescriptor(
            ...
            cost_model=ProductCostModel(has_funding_fee=True, has_borrow_interest=False)
        ))
    ...
    def get_descriptor(self, product_type: ProductType) -> ProductDescriptor:
        if product_type not in self._products:
            raise UnsupportedProductType(f"Product type {product_type} is not supported or not registered.")
