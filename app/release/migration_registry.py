...
class MigrationDef:
    def __init__(self, id: str, source: str, target: str, domain: str, severity: MigrationSeverity):
        self.id = id
        self.source = source
        self.target = target
        self.domain = domain
...
class MigrationRegistry:
    ...
    def _register_default_migrations(self):
        # Dummy migrations
        self.register(MigrationDef("mig_v1_to_v2", "v1", "v2", "config", MigrationSeverity.LOW))
