...
class LifecycleManager:
    def detect_changes(self,
                       ...
                       event_id_prefix: str = "evt_") -> List[LifecycleEvent]:
        events = []
        ...
        if old_inst.status != new_inst.status:
            ...
            elif old_inst.status == InstrumentStatus.MAINTENANCE and new_inst.status == InstrumentStatus.TRADING:
        ...
        if old_inst.filters.tick_size and new_inst.filters.tick_size:
            if old_inst.filters.tick_size.tick_size != new_inst.filters.tick_size.tick_size:
                filters_changed = True

        if old_inst.filters.step_size and new_inst.filters.step_size:
             if old_inst.filters.step_size.step_size != new_inst.filters.step_size.step_size:
                filters_changed = True
