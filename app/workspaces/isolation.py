...
class ContaminationChecker:
    ...
    def check_for_contamination(
        self, workspace_id: str, profiles: List[WorkspaceProfile]
                ...
                if sr in state_roots:
                    ...
                    findings.append(
                        ContaminationFinding(
                            ...
                            if (p.live_affecting or state_roots[sr].live_affecting)
                            else ContaminationSeverity.HIGH,
                            impacted_profiles=[
                                WorkspaceProfileRef(
                                ...
                                WorkspaceProfileRef(
                                    workspace_id=state_roots[sr].workspace_id,
                                    profile_id=state_roots[sr].profile_id,
                                    profile_type=state_roots[sr].profile_type,
                                ),
                            ],
                            evidence={"shared_state_root": sr},
                            recommended_actions=[
                                "Re-initialize scoped paths for impacted profiles",
