...
with open("app/readiness_board/admissibility.py", "r") as f:
    text = f.read()
text = text.replace(
    "from app.readiness_board.exceptions import InadmissibleEvidenceError", ""
)
...
with open("app/readiness_board/decisions.py", "r") as f:
    text = f.read()
text = text.replace(
    "from app.readiness_board.enums import BoardVerdict, DomainVerdict, ReadinessDomain",
...
with open("app/readiness_board/dossier.py", "r") as f:
    text = f.read()
text = text.replace(
    "    app.readiness_board.models import (",
