...
fix_file(
    ...
    "from app.experiments.models import ExperimentComparison\n",
    "",
)
fix_file(
    "app/experiments/fragility.py",
    "from app.experiments.models import ExperimentFragilityReport\n",
    "",
)
fix_file(
...
fix_file(
    "app/experiments/models.py",
    "PromotionClass, ExperimentVerdict, ScopeType",
    "PromotionClass, ScopeType",
)
...
fix_file(
    ...
    'assert reg.check_freshness("b_1") == True',
