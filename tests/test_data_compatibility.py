from app.data_governance import SchemaCompatibilityChecker, DataSchema, SchemaField, SchemaCompatibility
...
def test_schema_compatibility_backward_compatible():
    ...
    schema2 = DataSchema(
        ...
        fields=[
            ...
            SchemaField(name="notes", dtype="str", nullable=True) # Adding nullable field is backward compat
        ],
        created_at=datetime.now(timezone.utc)
    )
