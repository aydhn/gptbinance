...
from app.evidence_graph.models import EvidenceGraphConfig, ArtefactScope, ArtefactDescriptor, ArtefactLineage
from app.evidence_graph.enums import ArtefactType, ScopeClass, RelationType, TraversalClass, CaseFileClass, CompletenessClass
...
def test_relation_registry():
    ...
    art1 = repo.artefact_registry.register_artefact(ArtefactType.POLICY_DECISION, scope, "policy", desc)
    art2 = repo.artefact_registry.register_artefact(ArtefactType.READINESS_MEMO, scope, "readiness", desc)
...
def test_lineage_traversal():
    ...
    a1 = repo.artefact_registry.register_artefact(ArtefactType.INCIDENT_SNAPSHOT, scope, "incident", desc)
    a2 = repo.artefact_registry.register_artefact(ArtefactType.POSTMORTEM_REPORT, scope, "postmortem", desc)

    repo.relation_registry.add_relation(a2.id, a2.type, a1.id, a1.type, RelationType.FOLLOWS_INCIDENT)
...
def test_gap_detection():
    ...
    repo.relation_registry._relations["BAD_EDGE"] = type("MockEdge", (), {
        "edge_id": "BAD_EDGE",
        "source_id": "missing",
        "target_id": "missing",
