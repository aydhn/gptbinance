import pytest
from app.exception_plane.assurance import AssuranceLinkageEvaluator
from app.exception_plane.models import ExceptionObject, ExceptionClass

def test_assurance_linkage_evaluator():
    evaluator = AssuranceLinkageEvaluator()
    ...
    assert res.is_assurance_safe == True
