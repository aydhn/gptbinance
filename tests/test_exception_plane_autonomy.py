import pytest
from app.exception_plane.autonomy import AutonomyLinkageEvaluator
from app.exception_plane.models import ExceptionObject, ExceptionClass

def test_autonomy_linkage_evaluator():
    evaluator = AutonomyLinkageEvaluator()
    ...
    assert res.is_autonomy_safe == True
