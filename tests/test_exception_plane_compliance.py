import pytest
from app.exception_plane.compliance import ComplianceLinkageEvaluator
from app.exception_plane.models import ExceptionObject, ExceptionClass

def test_compliance_linkage_evaluator():
    evaluator = ComplianceLinkageEvaluator()
    ...
    assert res.is_compliance_safe == True
