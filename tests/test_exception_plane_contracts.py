import pytest
from app.exception_plane.contracts import ContractsLinkageEvaluator
from app.exception_plane.models import ExceptionObject, ExceptionClass

def test_contracts_linkage_evaluator():
    evaluator = ContractsLinkageEvaluator()
    ...
    assert res.is_contracts_safe == True
