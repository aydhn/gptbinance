import pytest
from app.exception_plane.finality import FinalityLinkageEvaluator
from app.exception_plane.models import ExceptionObject, ExceptionClass

def test_finality_linkage_evaluator():
    evaluator = FinalityLinkageEvaluator()
    ...
    assert res.is_finality_safe == True
