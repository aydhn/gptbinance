import pytest
from app.exception_plane.liability import LiabilityLinkageEvaluator
from app.exception_plane.models import ExceptionObject, ExceptionClass

def test_liability_linkage_evaluator():
    evaluator = LiabilityLinkageEvaluator()
    ...
    assert res.is_liability_safe == True
