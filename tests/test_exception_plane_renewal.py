import pytest
from app.exception_plane.renewal import RenewalLinkageEvaluator
from app.exception_plane.models import ExceptionObject, ExceptionClass

def test_renewal_linkage_evaluator():
    evaluator = RenewalLinkageEvaluator()
    ...
    assert res.is_renewal_safe == True
