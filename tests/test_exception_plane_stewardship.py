import pytest
from app.exception_plane.stewardship import StewardshipLinkageEvaluator
from app.exception_plane.models import ExceptionObject, ExceptionClass

def test_stewardship_linkage_evaluator():
    evaluator = StewardshipLinkageEvaluator()
    ...
    assert res.is_stewardship_safe == True
