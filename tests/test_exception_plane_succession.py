import pytest
from app.exception_plane.succession import SuccessionLinkageEvaluator
from app.exception_plane.models import ExceptionObject, ExceptionClass

def test_succession_linkage_evaluator():
    evaluator = SuccessionLinkageEvaluator()
    ...
    assert res.is_succession_safe == True
