import pytest
from app.exception_plane.viability import ViabilityLinkageEvaluator
from app.exception_plane.models import ExceptionObject, ExceptionClass

def test_viability_linkage_evaluator():
    evaluator = ViabilityLinkageEvaluator()
    ...
    assert res.is_viability_safe == True
