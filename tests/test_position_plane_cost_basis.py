...
class TestCostBasis(unittest.TestCase):
    def test_weighted_average(self):
        lot1 = LotManager.create_lot_from_fill({"symbol": "BTC", "side": "long", "quantity": "1.0", "price": "100"}, "sleeve-1")
        lot2 = LotManager.create_lot_from_fill({"symbol": "BTC", "side": "long", "quantity": "2.0", "price": "200"}, "sleeve-1")

        basis = CostBasisCalculator.calculate([lot1, lot2], CostBasisClass.WEIGHTED_AVERAGE)
