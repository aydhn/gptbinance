...
class TestPositionStates(unittest.TestCase):
    def test_apply_fill_open_long(self):
        state = PositionStateManager.create_empty_state("BTCUSDT", ProductClass.SPOT_PAIR, "sleeve-1")
        fill = {"symbol": "BTCUSDT", "side": "long", "quantity": "1.0", "price": "50000"}
    ...
    def test_apply_fill_reverse(self):
        state = PositionStateManager.create_empty_state("BTCUSDT", ProductClass.SPOT_PAIR, "sleeve-1")
        fill1 = {"symbol": "BTCUSDT", "side": "long", "quantity": "1.0", "price": "50000"}
        PositionStateManager.apply_fill(state, fill1)

        fill2 = {"symbol": "BTCUSDT", "side": "short", "quantity": "1.5", "price": "51000"}
