...
def test_analyze_impact_low():
    ...
    diff = UniverseDiff(
        ...
        added=[InstrumentRef(symbol="BTCUSDT", product_type=InstrumentType.SPOT, canonical_symbol="BTCUSDT")],
        removed=[],
        status_changed=[],
        eligibility_changed=[],
...
def test_analyze_impact_medium():
    ...
    diff = UniverseDiff(
        ...
        new_snapshot_id="snap2",
        added=[],
        removed=[InstrumentRef(symbol="BTCUSDT", product_type=InstrumentType.SPOT, canonical_symbol="BTCUSDT")],
        status_changed=[],
        eligibility_changed=[],
        created_at=datetime.now(timezone.utc)
    )
